...
# test_distribution_a(n_samples=1e8, n_dof=1)
# test_distribution_a(n_samples=1e8, n_dof=2)
# test_distribution_a(n_samples=1e8, n_dof=3)
# test_distribution_a(n_samples=1e8, n_dof=4)
# test_distribution_a(n_samples=1e8, n_dof=5)
# test_distribution_a(n_samples=1e8, n_dof=6)
# test_distribution_a(n_samples=1e8, n_dof=7)
# test_distribution_a(n_samples=1e8, n_dof=8)
# test_distribution_a(n_samples=1e8, n_dof=9)
# test_distribution_a(n_samples=1e8, n_dof=10)


# x = np.linspace(0, 2, 1000)
# f_ih = [irwin_hall_distribution(xi) for xi in x]
# fig, ax = new_fig()
# ax.plot(x, f_ih)


# p1 = get_acceptance_rate_distance_wrapper(world_size=2*2*np.pi, verbose=2, n_dim=1)
# get_acceptance_rate_distance_wrapper(world_size=1, verbose=2, n_dim=2)
# get_acceptance_rate_distance_wrapper(world_size=1, verbose=2, n_dim=3)
#
# p = np.zeros(50)
# d = np.linspace(0, 2*2*np.pi, 50)
# for o, dd in enumerate(d):
#     p[o] = p1(dd)
#
# fig, ax = new_fig()
# ax.plot(d, p)
...
# Plot for 1D, 2D, 3D and for multiple 1D

# y_1_interp = interp.interp1d(xc, y_1)
#
# fig, ax = newfig()
# ax.plot(xc, y)
# ax.plot(xc, y_a)
...
#
# fig, ax = newfig()
# ax.plot(xc, np.cumsum(y))
# ax.plot(xc, np.cumsum(y_1))
# ax.plot(xc, np.cumsum(y_a_y))
##
# test_distribution(p=y_a_y, n_samples=10000)
#
#
# n_samples = int(1e6)
#
